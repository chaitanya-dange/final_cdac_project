...
const SignUp = (props) => {
  ...
  const handleChange = (e) => {
    ...
    setFormValues({ ...formValues, [name]: value });//... is spread 
  };
...
/*By default, when a user submits a form, the browser will reload the page.
 This is the default behavior of HTML forms. However, you can prevent the default form 
 submission behavior by using the preventDefault() method of the Event object.


If you are using Axios to perform an asynchronous HTTP request when the form is submitted, 
you can use the preventDefault() method to prevent the page from reloading. 
This allows you to perform the Axios POST request without reloading the page. */
